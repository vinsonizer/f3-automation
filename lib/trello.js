...
trello.getServiceArgs = function() {
  ...
  return {
    service_name: 'trello',
    access_token_url: 'https://trello.com/1/OAuthGetRequestToken',
    request_token_url: 'https://trello.com/1/OAuthAuthorizeToken?expiration=' + cfg.expiration,
    authorization_url: 'https://trello.com/1/OAuthGetAccessToken',
