var config = {
    // Feed by region, if you go to your schedules landing page you find it
    url: "http://f3nation.com/locations/fort-mill-sc/feed/",
    /*
    File Id for Google sheet.  Open Sheet in browser and copy
    string after the d/ up to /edit
    */
    fileId: "1B5l_olGDsHI8fL_kzR9h4V5lFrJysB3a6xvU7sct7lk",
    /*
    Name of the sheet inside the google sheet
    Assumes Columns are:
